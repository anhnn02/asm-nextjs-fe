    ...
    const onSubmit = async (data: IProduct) => {
      const file = image
        ...
        if (+data.salePrice !== 0 || +data.regularPrice !== 0) {
          toast.error(" Price must be is number and is different from 0", {
            position: "top-center",
          });
        }
        } else {
          ...
          <div className={stylesAdmin["content-form_admin"]}>
            <div className={stylesAdmin["inside_form_admin"]}>
                ...
                <div className="">
                  ...
                  <div className={stylesAdmin["row_2-col"]}>
                    ...
                    <div className={stylesAdmin["row-input_form"]}>
                      ...
                      <select
                        className="tw-my-1 tw-input tw-input-bordered tw-w-full "
                ...
                <div className="">
                  ...
                  <div className={stylesAdmin["row-input_form"]}>
                    ...
                    <div className={`${stylesAdmin["size_row"]}`}>
                      <div
                        className={`${styles["shop-main"]} ${styles["size_col"]} `}
                      >
                        <div className={styles["shop-sidebar-variation"]}>
                          <div
                            className={`${styles["form-group"]} ${styles["form-group-35"]}`}
                          >
                            <input
                              type="checkbox"
                              id="size-35"
                          ...
                          <div
                            className={`${styles["form-group"]} ${styles["form-group-36"]}`}
                          >
                            <input
                              type="checkbox"
                              id="size-36"
                          ...
                          <div
                            className={`${styles["form-group"]} ${styles["form-group-37"]}`}
                          >
                            <input
                              type="checkbox"
                              id="size-37"
                          ...
                          <div
                            className={`${styles["form-group"]} ${styles["form-group-38"]}`}
                          >
                            <input
                              type="checkbox"
                              id="size-38"
                          ...
                          <div
                            className={`${styles["form-group"]} ${styles["form-group-39"]}`}
                          >
                            <input
                              type="checkbox"
                              id="size-39"
                          ...
                          <div
                            className={`${styles["form-group"]} ${styles["form-group-40"]}`}
                          >
                            <input
                              type="checkbox"
                              id="size-40"
                          ...
                          <div
                            className={`${styles["form-group"]} ${styles["form-group-41"]}`}
                          >
                            <input
                              type="checkbox"
                              id="size-41"
                          ...
                          <div
                            className={`${styles["form-group"]} ${styles["form-group-42"]}`}
                          >
                            <input
                              type="checkbox"
                              id="size-42"
                          ...
                          <div
                            className={`${styles["form-group"]} ${styles["form-group-43"]}`}
                          >
                            <input
                              type="checkbox"
                              id="size-43"
              ...
              <div className={`${stylesAdmin["row-input_form"]}`}>
                ...
                <textarea
                  rows={5}
                  className="tw-textarea tw-textarea-bordered tw-w-full tw-h-24"
                  {...register("desc")}
                ></textarea>
              </div>
              {/* BUTTON */}
